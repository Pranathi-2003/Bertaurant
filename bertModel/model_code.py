...
df = pd.read_csv(r'C:\Users\prana\vscode_Folders\bertaurant\bertModel\Restaurant_Reviews.tsv', delimiter='\t') #2 columns: Review, Liked
...
for epoch in range(num_epochs):
    model.train()                      #layers like dropout layer behave differently while training and evaluating
    total_loss = 0
